...
func newPostgresRecipesCommand(parent *Command, client *client.Client) *Command {
	...
	// detachCmd.AddStringFlag(StringFlagOpts{Name: "database", Description: "Detach database from target app"})
...
// 	if databaseName == "" {
// 		databaseName = strings.ReplaceAll(app.Name, "-", "_")
// 	}
...
// 	return recipes.PostgresAttachRecipe(cmdCtx, &input)
// }
